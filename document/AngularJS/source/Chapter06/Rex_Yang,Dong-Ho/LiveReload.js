...
Options.extract = function(document) {
  ...
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    element = _ref[_i];  //script태그로 받은 배열의, i번째 요소
    
    //******* 수정내역 By.Rex *******
    //console.log(element);      //추가코드 (확인)  //<script src="http://localhost:35729/livereload.js?snipver=1"></script>
    //console.log(element.src);  //추가코드 (실제로 넘어오는 src확인)  //file:///D:/Desktop/Pro_AngularJS/common/LiveReload.js?snipver=1
    element.src = 'http://localhost:35729/livereload.js?snipver=1';  //★★★이거 딱한줄 추가하니까 잘됨.
    //console.log(element.src.match(/^[^:]+:\/\/(.*)\/z?livereload\.js(?:\?(.*))?$/));
    //추가코드 (조작된 src)
